...
### v1.0.8 (2026-07-07)
- Removed public "Sheet Setup" links from the header navigation menu for cleaner client UI and improved security.
- Incremented codebase version to v1.0.8.

### v1.0.7 (2026-07-07)
- Pre-configured the default Google Sheets logging endpoint using the user's newly deployed secure Web App URL (Base64-obfuscated).
- Incremented codebase version to v1.0.7.

### v1.0.6 (2026-07-07)
- Implemented Base64 URL obfuscation for sheet URL strings to prevent basic crawler bot indexing.
- Implemented client-side and structural HTML honeypot spam filters to discard bot submissions quietly.
- Incremented codebase version to v1.0.6.
...
- Incremented codebase version to v1.0.4.

### v1.0.3 (2026-07-07)
- Pre-configured the default Google Sheets logging endpoint using the user's deployed web app URL.
- Added automatic load-prepopulation in settings.
- Incremented codebase version to v1.0.3.
